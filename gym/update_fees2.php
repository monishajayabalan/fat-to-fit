...
$tyre = $_GET['edit_id'];
$tyre_query = mysqli_query($conn,"SELECT * from fam_fees where f_id='$tyre'");
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    mysqli_query($conn,"UPDATE fam_fees SET `month` = '$month', `months` = '$months',`year` = '$year' WHERE f_id='$tyre'");
