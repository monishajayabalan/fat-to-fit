      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>Time Schedule</font></h3>
                
                <br>
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                    	
                               <!-- <th><font color="#f8f8ff" size="5"> id</font></th> -->
                               <th><font color="#f8f8ff" size="5"> Trainer name</font></th>
                               <th><font color="#f8f8ff" size="5">working time</font></th>
                               <th><font color="#f8f8ff" size="5"> working days</font></th>
                    ...
                    if(mysqli_num_rows($result) >0)
                    {
                        ...
                        while($row1=mysqli_fetch_array($result)){
                            ...
                            <tr align="center">
                               ...
                               <!-- <td><font color="yellow" size="5"><a href="insedit.php?v=<?php echo $row1['id']?>">add</a></td></tr> -->
