...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>attendance .....</span></h3>
            ...
            <!-- <input type="text" name="name" placeholder="name" required="" class="form-control" /> -->
						<input type="date" name="uname" placeholder="date" required="" class="form-control" />
						<input type="text" name="time" placeholder="status" required="" class="form-control" />
    ...
    $result=mysqli_query($conn,"INSERT INTO attendance(`name`,`date`,`status`)  VALUES('$date','$uname','$time')");
      }
?>
						</form>
					</div>
