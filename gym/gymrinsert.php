...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>equipment....</span></h3>
					<form action="gymrinsert.php" method="POST" >
						
                        <input type="text" name="name" placeholder="equpmentname" required="" class="form-control" />
    ...
    $result=mysqli_query($con,"insert into gym values(null,'$name')");
      }
?>
					</div>
