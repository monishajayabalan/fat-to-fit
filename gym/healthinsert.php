...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span> user health detials  .....</span></h3>
            ...
            <input type="text" name="name" value="<?php echo $row_user['username']?>" placeholder="username" required="" class="form-control" />
            <?php
            // }
           }
              ?>
            ...
            <!-- <input type="number" name="hhh" placeholder="login_id" required="" class="form-control" /> -->
						<!-- <input type="text" name="name" placeholder="username" required="" class="form-control" /> -->
						<input type="text" name="uname" placeholder="healthdetials" required="" class="form-control" />
    ...
    $result=mysqli_query($conn,"INSERT INTO health(username,healthdetials,login_id)  VALUES('$date','$uname','$hhh')");
      }
?>
						</form>
					</div>
