...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>reply medical doubts .....</span></h3>
           ...
           <!--  <?php
            ...
            // echo $row_user['username']?>"  class="form-control" required="" />
          ...
          // } ?>
            ...
            <input type="text" name="replay" placeholder="reply" required="" class="form-control" />
    ...
    $result=mysqli_query($conn,"INSERT INTO medical(`username`,replay)  VALUES('$username','$replay')");
      }
?>
						</form>
					</div>
