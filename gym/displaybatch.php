      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>new batch & user allot instructor</font></h3>
                
                <br>
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                               <!-- <th><font color="#f8f8ff" size="5">login_id</font></th> -->

                        <th><font color="#f8f8ff" size="5">name</font></th>

                        <th><font color="#f8f8ff" size="5">batch</font></th>
                        <th><font color="#f8f8ff" size="5">Date</font></th>
                        <th><font color="#f8f8ff" size="5">Time</font></th>
                        <th><font color="#f8f8ff" size="5">Instructor</font></th>
                ...
                <?php
                    include "connect.php";
                    $result=mysqli_query($conn,"  SELECT * from `newbatch` where `name` = '$user'");
                    if(mysqli_num_rows($result) >0)
                    {
                        ...
                        while($row1=mysqli_fetch_array($result)){
                            ?>
                            <tr align="center">
                                <!-- <td><font color="yellow" size="5"><?php
                                //  echo $row1[1];?></font></td> -->
                                <td><font color="yellow" size="5"><?php echo $row1[2];?></font></td>
                                <td><font color="yellow" size="5"><?php echo $row1[3];?></font></td>
                                <td><font color="yellow" size="5"><?php echo $row1[4];?></font></td>
                                <td><font color="yellow" size="5"><?php echo $row1[5];?></font></td>
                                <td><font color="yellow" size="5"><?php echo $row1[6];?></font></td>
