    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" id="nav">
            ...
            <li>
							<a class="nav-link" href="hfooddisplay.php">view healthfood</a>
						</li>
            <li>
              <a class="nav-link" href="displaybatch.php">new batches</a>
            </li>
            <li>
              <a class="nav-link" href="medical.php">add medicaldoubts </a>
            </li>
             <li>
              <a class="nav-link" href="doubtsdisplay.php">reply </a>
            </li>
            
            <li>
							<a class="nav-link" href="healthinsert.php">user health </a>
						</li>
              
						<li class="nav-item">
							<a class="nav-link" href="gdisplay.php"> gym equipment</a>
						</li>
						<li class="nav-item">
							<a class="nav-link" href="tmdisplay.php">transformation </a>
						</li>
                        <li class="nav-item">
							<a class="nav-link" href="mdisplay1.php">View_medicines</a>
						</li>
                        </li>
                        <li class="nav-item">
							<a class="nav-link" href="feedbackinsert.php">add feedback</a>
						</li>
                        </li>
                        <li class="nav-item">
							<a class="nav-link" href="displaypayment.php"> payment details</a>
						</li>
                        <li class="nav-item">
							<a class="nav-link" href="adisplay.php"> attendance</a>
						</li>
                        <li class="nav-item">
							<a class="nav-link" href="payment.php">add payments</a>
						</li>
            <li class="nav-item">
              <a class="nav-link" href="insreplay.php">view food & diet</a>
            </li>
            <li class="nav-item">
              <a class="nav-link" href="viewtimesche.php">view time schedule</a><br>
              <!-- <a class="nav-link" href="userdisplay.php">userprofile</a> -->
            ...
            <li class="nav-item">
              <a class="nav-link" href="bot2.php"></a>
            </li>
						<li class="nav-item">
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
<marquee direction="left"><h2><font color="white">Welcome user</font></h2></marquee>
								            </div>
            </div>
          </div>
          <!-- Slideshow 4 --
          <div class="slider">
            ...
            <!-- This is here just to demonstr        ate the callbacks -->
          </div>
          <!-- //Slideshow 4 --
          <div class="clearfix"></div>
        </div>
...
<div class="col-lg-5 mail-grid1-form ">
        ...
        <h3 class="tittle-w3"><span>Login Here</span></h3>
          ...
          <form action="log.php" method="post">
            ...
            <table>
              <tbody>
            <tr><td><label><font color="white">Username</font></label>
            <input type="string" name="name" required="" /></td></tr>
            <tr><td><label><font color="white">Password</font></label>&nbsp;
            <input type="password" name="pass" required="" /></td></tr>
            </tbody>
            </table>
            <br>
