...
<html lang="zxx">
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>userprofile</font></h3>
                
                <br>
                <table align="center" bgcolor="blue" border="2" style="width: 800px;">
                    <tr align="center">
 ...
 <td> <img src="<?php echo $row1['image_path'];?>" height="100" width="150"></td>
