...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>Add feedback &complaints .....</span></h3>
					<form action="" method="post" >
          <input type="text" name="username" placeholder="username" required="" class="form-control" />

						<input type="text" name="name" placeholder="feedback & complaints" required="" class="form-control" />
    ...
    $result=mysqli_query($conn,"INSERT INTO feedback(username,feedback)  VALUES('$username','$date')");
      }
?>
						</form>
					</div>
