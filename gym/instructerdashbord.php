    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" id="nav">
            ...
            <li>
							<a class="nav-link" href="transforminsert.php">add transformatiom</a>
						</li>
             <li>
              <a class="nav-link" href="inserthealth.php">add health foods</a>
            </li>
            
            <li>
							<a class="nav-link" href="attendance.php">add the attendance</a>
						</li>
            <li class="nav-item">
              <a class="nav-link" href="insreplay1.php">view user food&diet</a>
            </li>

						<li class="nav-item">
							<a class="nav-link" href="tmdisplay2.php">view transformation</a>
						</li>
            <li>
              <a class="nav-link" href="viewusers.php">view users</a>
            </li>
						<!-- <li class="nav-item">
							<a class="nav-link" href="timeinsert.php">Time Schedule </a>
						</li> -->
						<li class="nav-item">
							<a class="nav-link" href="insdisplay.php">view the attendance</a>
						</li>
            <li class="nav-item">
							<a class="nav-link" href="foodinsert.php">add food&diet</a>
						</li>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
<marquee direction="left"><h2><font color="white">Welcome instructor</font></h2></marquee>
								            </div>
            </div>
          </div>
          <!-- Slideshow 4 --
