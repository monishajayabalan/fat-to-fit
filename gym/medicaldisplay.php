      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b> view user medical doubts</font></h3>
                
                <br>
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                               <th><font color="#f8f8ff" size="5"> username</font></th>
                               <th><font color="#f8f8ff" size="5"> doubts</font></th>
                               <th><font color="#f8f8ff" size="5"> reply</font></th>
                    ...
                    <?php
                    include "connect.php";
                    $result=mysqli_query($conn,"select * from medical_doubts");
                    if(mysqli_num_rows($result) >0)
                    {
                        ...
                        while($row1=mysqli_fetch_array($result)){
                            ...
                            <tr align="center">
                                ...
                                // echo $row1[3];?></font></td> -->
                                <td><font color="yellow" size="5"><a href="medicaldoubts.php?edit_id=<?php echo $row1['username'];?>">reply</a></td></tr>
