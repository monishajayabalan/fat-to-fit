...
<html lang="zxx">
  ...
  <body>
    <div class="header-outs" id="header">
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>user medical doubtes .....</span></h3>
            ...
            <input type="text" name="username" value="<?php echo $row_user['username']?>" placeholder="username" required="" class="form-control" />
            <input type="text" name="medical_doubts" placeholder="medical_doubts" required="" class="form-control" />
            <?php
            // }
           }
              ?>
     ...
     $medical_doubts=$_POST['medical_doubts'];
    //  $uname=$_POST['uname'];
     
    
    
    
    $result=mysqli_query($conn,"INSERT INTO medical_doubts(username,medical_doubts)  VALUES('$username','$medical_doubts')");
      }
?>
						</form>
					</div>
