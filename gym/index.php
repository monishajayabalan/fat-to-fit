        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" id="nav">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" data-aos="fade-left">
              <ul class="navbar-nav">
              <li>
							<a class="nav-link" href="viewfees.php">Fee Structure</a>
						</li>
&nbsp;&nbsp;&nbsp;&nbsp;
               <li>
...
&nbsp;&nbsp;&nbsp;&nbsp;
						<li>
							<a class="nav-link" href="register1.php">user registration</a>
						</li>
            <li>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
<marquee direction="left"><h2><font color="white">home</font></h2></marquee>
								            </div>
            </div>
          </div>
          <!-- Slideshow 4 --
