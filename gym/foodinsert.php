...
<li>
							<a class="nav-link" href="admin_update.php"></a>
						</li>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
				...
				<h3 class="tittle-w3"><span>Add food and diet</span></h3>
          ...
          data-aos-easing="ease-in-sine">
            ...
            $sql="SELECT login_id from `login` ";
            $res_user=mysqli_query($conn,$sql);
            // $id=$res_user['login_id'];
            ...
            //  echo $row_user['login_id']?>"  class="form-control" required="" />

            <?php
            // }
           }
              ?> -->
						 <!-- <input type="number" name="num" placeholder="login_id" class="form-control" required="" />  -->
					</div><br>
              <div class="col-md-4 form-group contact-forms">

                  <select name="name" id="name" Placeholder="username" required="" class="form-control">
            ...
            $res_user=mysqli_query($conn,$sql);
             ...
             while($row_user=mysqli_fetch_assoc($res_user)){?>
                        <option id="<?php 
                        echo $row_user['login_id']?>">
                        <?php echo $row_user['username']?></option>
            <?php } ?>
            </select>
              ...
              <div class="col-md-4 form-group contact-forms">
						...
						<input type="text" name="food" placeholder="foods" class="form-control" required="" />
					</div><br>
              <!-- <div class="col-md-4 form-group contact-forms">

							
						<input type="text" name="eat" placeholder="yes or no" class="form-control" required="" />
					</div><br> -->
    ...
    $result=mysqli_query($conn,"INSERT INTO food(`name`,`food` )  VALUES('$uname','$time')");
      }
?>
</div>					
