...
<html lang="zxx">
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" data-aos="fade-left">
              <ul class="navbar-nav">
                                <li>
                            <a class="nav-link" href="customer.php"></a>
                        </li>
                        ...
                        <li class="nav-item">
                         ...
                         <li class="nav-item">
              <a class="nav-link" href="userdashbord.php">Back</a>
            </li>
                            </ul>
            </div>
          </nav>
          ...
          <div class="hedder-up " >
           ...
           <?php
            ...
            // $total = mysqli_num_rows($res_user);
             ...
             ?>
            <input type="text" name="username" value="<?php echo $row_user['username']?>"  class="form-control" required="" />
            
            <?php
            // }
           }
              ?>
				<!-- <input class="name" type="number" name="num" placeholder="login_id" required=""> -->
						<input class="name" type="text" name="name" placeholder="Name on Card" required="">
						<input type="text" name="number" placeholder="Card Number" required="" minlength="13" maxlength="13">
						<input type="date"class="name"  name="date" placeholder="Expiration Date" required="">
						<input type="text" name="cvv" placeholder="cvv" required="" minlength="3" maxlength="3">
						<input type="text" name="amnt" placeholder="Amount" required="">
						<div class="clearfix"> </div>
  ...
  $d=$_POST['cvv'];
  $e=$_POST['amnt'];
$result=mysqli_query($conn,"INSERT INTO payment(`username`,`name`,`number`,`date`,`cvv`,`amount`) 
VALUES ('$username','$a','$b','$c','$d','$e')");
}
?>
