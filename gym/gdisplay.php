      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>gym equipment</font></h3>
                 <form  method="post"  enctype="multipart/form-data">
                <br>
                <table align="center" bgcolor="pink" border="2" style="width: 700px;">
                    <tr align="center">
                              
                              
                    	        
                               <th><font color="red">product</th></font></font>
                                <th><font color="re">details</th></font>
                                <th><font color="red">price</th></font>
                                <th><font color="red">photos</th></font></font>
                                <th><font color="red">Action</th></font></font>
 </tr>
                   <?php
  
  include "connect.php";  
 $dat=mysqli_query($conn,"SELECT * FROM product_tb");
  ?>
                      ...
                      while( $data=mysqli_fetch_assoc($dat)){
                          ?>
                           ...
                           <tr> 
                            ...
                            <td> <img src="<?php echo $data['image_path'];?>" height="100" width="250"><td>
                            <!-- <td class="text-center"> -->
                            <?php 
               if($data['status']=='0')  {?>
                <a class="dropdown-item" href="book.php?del_id=<?php echo $data['id'];?>">BOOKNOW</a>
                <?php }  else{
                  ?>
                <a class="dropdown-item" href="?del_id=<?php echo $data['id'];?>">BOOKED</a>
                                                            <?php } ?></td>
