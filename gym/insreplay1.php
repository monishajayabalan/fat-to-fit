      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>View and edit food and diet</font></h3>
                    ...
                    if(mysqli_num_rows($result) >0)
                    {
                        ...
                        while($row1=mysqli_fetch_array($result)){
                            ...
                            <tr align="center">
                                ...
                                <!-- <td><font color="yellow" size="5"><a href="foodedit.php?v=<?php
                                //  echo $row1['id']?>">edit</a></td></tr> -->
