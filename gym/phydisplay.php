...
<html lang="zxx">
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>physician appoinment
                 </font></h3>
                
                <br>
                <table align="center" bgcolor="red" border="2" style="width: 800px;">
                    <tr align="center">
                               <th><font color="#f8f8ff" size="5">name</font></th>

                        <th><font color="#f8f8ff" size="5">email</font></th>
                        <th><font color="#f8f8ff" size="5">mobile</font></th>

                        <th><font color="#f8f8ff" size="5">gender</font></th>
                        <th><font color="#f8f8ff" size="5">upload</font></th>
                         <th><font color="#f8f8ff" size="5">approved</font></th>
                    ...
                    <?php
                    include "connect.php";
                    $result=mysqli_query($conn,"select * from register1 where login_id='$user'");
 ...
 <td> <img src="<?php echo $row1['image_path'];?>" height="100" width="100"></td>
  <td><?php 
  if($row1['status']=='0') 

{?>
                                          <a style="color:white;" class="dropdown-item" href="phyapprove_user.php?edit_id=<?php echo $row1['reg_id'];?>">APPROVE</a>
                                       <?php }  else{
                                           ?>
                                           <a style="color:white;"class="dropdown-item" href="?edit_id=<?php echo $row1['reg_id'];?>">APPROVED</a>
                                  <?php } ?>
   </td>
