    ...
    <div class="header-outs" id="header">
        ...
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" id="nav">
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent" data-aos="fade-left">
              <ul class="navbar-nav">
               <li>
							<a class="nav-link" href="register.php">register instructor</a>
						</li>

						<li>
							<a class="nav-link" href="register.php">register physician</a>
						</li>
            ...
            <li>
							<a class="nav-link" href="aqupmentinsert.php">gym requirements</a>
						</li>
            <li>
							<a class="nav-link" href="fdisplay.php">view feedback</a>
						</li>
            <li>
							<a class="nav-link" href="newbatchinsert.php">add newbatch&user allot instructer</a>
						</li>

						<li class="nav-item">
							<a class="nav-link" href="edit_fees.php">Fee Structure</a>
  </li>
						<li class="nav-item">
							<a class="nav-link" href="pay.php">Payment Details</a>
  </li>
						<li class="nav-item">
							<a class="nav-link" href="admindisplay.php">view the attendance</a>
						</li>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
<marquee direction="left"><h2><font color="white">Welcome Admin</font></h2></marquee>
								            </div>
            </div>
          </div>
          <!-- Slideshow 4 --
