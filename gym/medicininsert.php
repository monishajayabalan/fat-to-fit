...
<html lang="zxx">
  ...
  <body>
      ...
      <div class="header-w3layouts">
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light">
            ...
            <li class="nav-item">
              <a class="nav-link" href="physiciandashbord.php">Back</a>
            </li>
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span> add medicine.....</span></h3>
					<form action="#" method="post" >
						<input type="text" name="name" placeholder="medicinename" required="" class="form-control" />
						<input type="text" name="uname" placeholder="stock" required="" class="form-control" />
						<input type="text" name="time" placeholder="price" required="" class="form-control" />
    ...
    $result=mysqli_query($conn,"INSERT INTO medicine(medicine_name,stocks,price)  VALUES('$date','$uname','$time')");
      }
?>
						</form>
					</div>
