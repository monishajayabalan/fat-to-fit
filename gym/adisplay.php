      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>attendance</font></h3>
                ...
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                        ...
                        <th><font color="#f8f8ff" size="5"> status</font></th>
                    ...
                    <?php
                    include "connect.php";
                    $result=mysqli_query($conn,"SELECT *  from `attendance` where `name` = '$user' ");
