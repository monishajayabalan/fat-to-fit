...
<html lang="zxx">
  ...
  <body>
    <div class="header-outs" id="header">
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          ...
          data-aos-easing="ease-in-sine">
				...
				<h3 class="tittle-w3"><span>transformation .....</span></h3>
					<form action="" method="post" >

            <!-- <?php
                $id=$_SESSION['login_id'];
                 
            $sql="SELECT login_id from login where login_id='$id'";
            ...
            // $total = mysqli_num_rows($res_user);
             ...
             ?>
            <input type="number" name="num" value="<?php echo $row_user['login_id']?>"  class="form-control" required="" />

            <?php
            // }
           }
              ?> -->
            <!-- <input type="number" name="id" placeholder="user_id" required="" class="form-control" />  -->
             <!-- <select name="name" id="username" Placeholder="username" required="" class="form-control">
            ...
            <?php } ?>
						...
						<input type="text" name="wheight" placeholder="weight" required="" class="form-control" />
						<input type="text" name="bmii_index" placeholder="bmi_index" required="" class="form-control" />
     ...
     $bmii_index=$_POST['bmii_index'];
     
    
    
    $result=mysqli_query($conn,"INSERT INTO transform(username,wheight,bmii_index)  VALUES('$username','$wheight','$bmii_index')");
      }
?>
						</form>
					</div>
