    ...
    <div class="header-outs" id="header">
      ...
      <div class="container">
        ...
        <center>
                ...
                <h3 align="center"><font color="yellow"><b></b>user appointment</font></h3>
                
                <br>
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                      
                               <!-- <th><font color="white" size="5"> login_id</font></th> -->
                               <th><font color="white" size="5"> name</font></th>
                               <th><font color="white" size="5"> email</font></th>
                               <th><font color="white" size="5"> mobile</font></th>
                               <th><font color="white" size="5"> gender</font></th>
                               <th><font color="white" size="5"> Age</font></th>
                               <th><font color="white" size="5"> weight</font></th>
                               <th><font color="white" size="5"> Address</font></th>
                               <th><font color="white" size="5">Image</font></th>
                               <!-- <th><font color="white" size="5">approved<br>status</font></th> -->
                    ...
                    if(mysqli_num_rows($result) >0)
                    {
                        ...
                        while($row1=mysqli_fetch_array($result)){
                            ?>
                            <tr align="center">
                                <!-- <td><font color="white" size="5"><?php
                                //  echo $row1[1];?></font></td> -->
                                <td><font color="white" size="5"><?php echo $row1[2];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[3];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[4];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[5];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[6];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[7];?></font></td>
                                <td><font color="white" size="5"><?php echo $row1[8];?></font></td>


                                <td> <img src="<?php echo $row1['image_path'];?>" height="100" width="100">
