...
<li>
      ...
      <div class="container">
        ...
        <h3 class="tittle-w3"><span>Add healthfood</span></h3>
        <div class=" contact-form aos-init aos-animate" data-aos="fade-left"
          ...
          <form action="#" method="post" >
            ...
            <input type="text" name="name" placeholder="healthfood" class="form-control" required="" />
            </div><br>
    ...
    $result=mysqli_query($conn,"INSERT INTO healthfood(login_id,healthfood )  VALUES('$date','$uname')");
      }
?>
</div>          
