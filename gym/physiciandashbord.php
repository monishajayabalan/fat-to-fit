    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
        <div class="container-fluid">
          ...
          <nav class="navbar navbar-expand-lg navbar-light" id="nav">
            ...
            <li>
              <a class="nav-link" href="medicininsert.php">add medicine information</a>
            </li>
            <li>
              <a class="nav-link" href="phyprofile.php">view your updated profile</a>
            </li>
            <li>
              <a class="nav-link" href="hsdisplay.php">view user health details </a>
            </li>
             <li>
              <a class="nav-link" href="medicaldisplay.php">view medical doubts </a>
            </li>
            
            <!-- <li>
              <a class="nav-link" href="userdisplay2.php"> physician approved user  </a>
            </li> -->
              
            <li class="nav-item">
              <a class="nav-link" href="mdisplay.php"> medicine information</a>
            </li>
            
            <li class="nav-item">
              <!-- <a class="nav-link" href="viewtimesche.php"></a><br> -->
              <a class="nav-link" href="bot.php">chatbox</a> -->
      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
<marquee direction="left"><h2><font color="white">Welcome physician</font></h2></marquee>
								            </div>
            </div>
          </div>
          <!-- Slideshow 4 --
