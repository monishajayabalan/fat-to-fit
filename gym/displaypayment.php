      ...
      <div class="container">
        <div class="banner-slide-img" data-aos="fade-up">
          <div class="hedder-up " >
                ...
                <h3 align="center"><font color="yellow"><b></b>payment</font></h3>
                ...
                <table align="center" bgcolor="black" border="2" style="width: 800px;">
                    <tr align="center">
                        ...
                        <th><font color="#f8f8ff" size="5">number</font></th>

                        <th><font color="#f8f8ff" size="5">date</font></th>
                        <th><font color="#f8f8ff" size="5">cvv</font></th>
                        <th><font color="#f8f8ff" size="5">amount</font></th>
                    ...
                    <?php
                    include "connect.php";
                    $result=mysqli_query($conn,"  SELECT * from `payment` where username = '$user'");
