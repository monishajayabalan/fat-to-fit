...
$tyre = $_GET['edit_id'];
$tyre_query = mysqli_query($conn,"select * from fees_tb where fees_id='$tyre'");
...
if($_SERVER["REQUEST_METHOD"]=="POST")
{
    ...
    mysqli_query($conn,"UPDATE fees_tb SET `month` = '$month', `months` = '$months',`year` = '$year' WHERE fees_id='$tyre'");
